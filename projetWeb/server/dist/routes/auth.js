...
const db_1 = require("../db"); // 🟢 ajout import DB pour sauvegarder le token & username
...
router.get("/github/callback", async (req, res) => {
    ...
    try {
        ...
        await db_1.db.query(`INSERT INTO users (email, github_token, github_username)
       VALUES (?, ?, ?)
       ON DUPLICATE KEY UPDATE
         github_token = VALUES(github_token),
         github_username = VALUES(github_username)`, [user.email, access_token, user.login]);
